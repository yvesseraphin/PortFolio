(function () {
  ...
  function buildNav(prev, next) {
    ...
    if (prev) {
      html +=
        '<a class="c-bInnJf" href="/projects/project/?slug=' +
        esc(prev.slug) +
        '">' +
    ...
    if (next) {
      html +=
        '<a class="c-bInnJf" style="margin-left:auto" href="/projects/project/?slug=' +
        esc(next.slug) +
        '">' +
    ...
    if (
      ...
      project.directContribution.forEach(function (contrib) {
        if (typeof contrib === "string" && contrib.trim()) {
          bodyHtml +=
            '<li class="project-list-item ' + P + '">' + esc(contrib) + "</li>";
        }
      });
      bodyHtml += "</ul>";
    }
