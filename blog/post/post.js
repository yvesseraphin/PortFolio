(function () {
  ...
  var CACHE_KEY = "post_cache_v9_" + slug;
  function readCache() {
    try {
      var raw =
  ...
  var P =
    "c-iLbGmI c-iLbGmI-cyRcZm-family-body c-iLbGmI-lewMmC-size-16 c-iLbGmI-bwnKsc-lineHeight-28 c-iLbGmI-cdWBIM-weight-400 c-iLbGmI-cOWITQ-color-gray12";
  var H =
    "c-iLbGmI c-iLbGmI-cyRcZm-family-body c-iLbGmI-lewMmC-size-16 c-iLbGmI-haFyCE-lineHeight-20 c-iLbGmI-hZNfDR-weight-500 c-iLbGmI-cOWITQ-color-gray12 c-iLbGmI-ifcaOLc-css";
  var S =
    "c-iLbGmI c-iLbGmI-cyRcZm-family-body c-iLbGmI-jIjxDA-size-14 c-iLbGmI-bwnKsc-lineHeight-28 c-iLbGmI-cdWBIM-weight-400 c-iLbGmI-hgsrmT-color-gray11";
  ...
  function buildCodeBlock(code, lang) {
    ...
    return (
      '<div class="codeblock_root__pf0C4" style="margin:24px 0"><div class="' +
      language +
      ' codeblock_editor__Hq7SO">' +
      linesHtml +
      "</div></div>"
    );
  }
    ...
    blocks.forEach(function (block) {
      ...
      if (style === "h2") {
        ...
        html +=
          ...
          '" data-heading="true" data-toc="true" class="' +
          H +
          '" style="margin-top:32px;margin-bottom:10px;font-size:20px;line-height:28px">' +
          text +
          "</h3>";
        ...
        html +=
          '<blockquote class="' +
          P +
          '" style="border-left:3px solid var(--colors-gray7);padding-left:18px;margin:24px 0;font-size:17px;line-height:28px;color:var(--colors-gray12)">' +
          text +
          "</blockquote>";
      } else if (text.trim()) {
        html +=
          '<p class="' + P + '" style="margin-bottom:16px">' + text + "</p>";
      }
    });
      ...
      .map(function (span) {
        ...
        marks.forEach(function (mark) {
          if (mark === "strong") {
            ...
            var def = (markDefs || []).find(function (d) {
              return d._key === mark;
            });
  ...
  function renderReferences(heading, items) {
    ...
    var html =
      ...
      H3_CLS +
      '" style="margin-top:40px;margin-bottom:12px;font-size:20px;line-height:28px">' +
      esc(heading || "References") +
      "</h3>";
    html +=
      '<ol class="c-lesPJm c-lesPJm-iilMZTZ-css c-lesPJm-ildRkSF-css" style="color:var(--colors-gray12);padding-left:20px;margin-top:12px">';
    items.forEach(function (item) {
      ...
      if (item && item.url) {
        ...
        html +=
          ...
          TEXT_CLS +
          '">' +
          esc(item && item.text ? item.text : String(item || "")) +
          "</span>";
      }
      html += "</li>";
    });
  ...
  function buildToc(items) {
    ...
    items.forEach(function (item) {
      ...
      a.style.cssText =
        "font-size:14px;color:var(--colors-gray11);line-height:1.4;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:block;max-width:190px;";
      nav.appendChild(a);
    });
  ...
  function buildNav(prev, next) {
    ...
    if (prev) {
      html +=
        '<a class="c-bInnJf" href="/blog/post/?slug=' +
        esc(prev.slug) +
        '">' +
    ...
    if (next) {
      html +=
        '<a class="c-bInnJf" style="margin-left:auto" href="/blog/post/?slug=' +
        esc(next.slug) +
        '">' +
  ...
  function initCopyButton() {
    ...
    function showCopied() {
      ...
      if (svg)
        svg.outerHTML =
          '<svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>';
      setTimeout(function () {
  ...
  function renderPost(post) {
    ...
    var canonical =
      "https://www.yvesseraphin.xyz/blog/post/?slug=" + (post.slug || "");
    var coverRef =
  ...
  function executeSWR() {
    ...
    var url =
      ...
      "&$slug=" +
      encodeURIComponent(JSON.stringify(slug));
